      ...
      <Container style={{ marginTop: '20px' }}>
        ...
        <Row>
          ...
          <h1
                ...
                <p className='text-secondary my-0' style={{ marginLeft: '15px', fontSize: '20px', marginRight: '26px' }}> Text fill up rooms perfect for laid-back meet-ups to corporate boardrooms
